...
//this file expots all DOM element used in the app;
...
export const totalTasksElement = document.getElementById('todo-tasks')
...
export const cancelEdit = document.getElementById('cancel-edit')
